        ...
        <div className="flex flex-col items-center gap-5 mt-5">
          <div className="flex gap-3">
            <button
              ...
              } flex gap-2 justify-center items-center px-4 rounded-lg`}
              onClick={() => handleCurrencyChange("ETM")}
            >
             <Image src={"/icon-eth.svg"} width={"25"} height={"25"} alt='icon-bsc' /> ETM
            </button>
            <button
              className={`p-2 ${
            ...
            >
             <Image src={"/icon-usdt.svg"} width={"25"} height={"25"} alt='icon-bsc' /> USDT
            </button>
            <button
              className={`p-2 ${
            ...
            >
             <Image src={"/icon-bsc.svg"} width={"25"} height={"25"} alt='icon-bsc' /> BDC
            </button>
          </div>
          <div className="flex flex-col items-center gap-5 mt-5">
              <h2 className='text-center text-xl font-Bakbak -mt-4'>1 $MK = $0.279</h2>
          ...
          <div className='flex flex-col gap-2 w-full md:w-6/12'>
            <label><b>{selectedCurrency}</b> you pay</label>
            <input
          ...
          <div className='flex flex-col gap-2 w-full md:w-6/12'>
            <label><b>$MK</b> you receive</label>
