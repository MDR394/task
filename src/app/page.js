    ...
    <>
      ...
      <section className="w-11/12 mx-auto mt-12">
        ...
        <p className="font-Roboto text-[22px] text-[#B7B4BB] mt-3">
          ...
          transform engagement in digital games into a rewarding experience,
          paving the way for self-improvement and business opportunities.
        </p>
      </section>
      ...
      <section className="flex flex-col-reverse md:flex-row mt-9 w-11/12 mx-auto bg-[#17151D] p-2 md:p-9 rounded-3xl">
        <div className="w-full md:w-2/4 flex flex-col">
          <p className="mx-auto mt-12 md:mt-[90px] px-3 py-2 bg-slate-300 inline rounded-3xl bg-gradient-to-r from-[#33E3A2] to-blue-500 text-black font-bold text-sm">
            EARN PASSIVE INCOME
          </p>
          <h1 className=" mt-5 text-[25px] md:text-[35px] font-light text-center leading-10">
            Earn NFT during presale as a VIP member and get passive income after
            each tournament
          </h1>
          <button className="mt-5 mx-auto px-6 py-4 rounded-full hover:bg-[#33E3A2] mb-[60px] border">
            LEARN MORE
          </button>
        </div>
      ...
      <section className="mt-[50px] w-11/12 mx-auto" id="steps">
        ...
        <p className="font-Roboto text-[22px] text-[#B7B4BB] mt-3">
          ...
          people to participate in with large prizes for winners.
        </p>
      </section>
      {/* ********************           Steps Section      *********************** */}
      <section className="mt-9 p-6 flex flex-col md:flex-row gap-[60px] md:gap-12 w-9/12 md:w-full mx-auto">
        <StepCard
          btnRotateDeg="-rotate-12"
          cardRotateDeg="rotate-3"
          src="/step1.png"
          title="BUY $THLX DURING PRESALE"
          step="1"
        />
        <StepCard
          btnRotateDeg="-rotate-2"
          cardRotateDeg="-rotate-3"
          src="/step2.png"
        ...
        <div className={`w-full`}>
          <div className="relative w-full">
            ...
            <div className="relative pb-[130px]">
              <h1 className=" font-Power text-[44px] md:text-[64px] text-white text-center mt-9">
                TOKENOMICS
              </h1>
              <div className="mt-[20px] w-11/12 mx-auto flex flex-col md:flex-row gap-12">
                ...
                <div className="w-full md:w-2/6">
                  ...
                  <h3 className="font-normal text-[17px] mt-4">
                    Half of total token supply will be set aside for the thrillx
                    presale. The intention is for all who buy the presale to
                    participate in competition.
                  </h3>
                  <h2 className="font-bold text-[20px] mt-5">
                    30% FOR STAKING AND COMPETITION REWARDS
                  </h2>
                  <h3 className="font-normal text-[17px] mt-4">
                ...
                <div className="w-full md:w-2/6">
                  ...
                  <h3 className="font-normal text-[17px] mt-4">
                    Thrillx is all about participation and community engagement
                    so we have set aside a good amount of tokens for community.
                  </h3>
                </div>
              </div>
            </div>
      ...
      <section className="mt-12 pb-12" id="roadmap">
        <h1 className=" font-Power text-[44px] md:text-[64px] text-white text-center mb-4 ">
          ROADMAP
        </h1>
        <TimeLine />
      </section>
          ...
          <div className="relative w-full">
            ...
            <div className="relative pb-[100px] pt-[100px]">
              <div className="mt-[20px] w-11/12 mx-auto flex justify-center">
                ...
                {/* *********************       Center Column   ********************** */}
                <div className="w-[40%">
                  <h1 className=" font-Power text-[71px] text-white text-center leading-[92px]">
                    JOIN OUR <br /> PRIZE <br /> GAME!
                  </h1>
                </div>
                {/* *********************       Right Column   ********************** */}
                <div className="w-[30%] flex flex-col justify-between items-center">
